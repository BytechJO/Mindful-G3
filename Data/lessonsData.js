...
const u3l2_vid6 = "/videos/unit3/L2/6.mp4";
//Lesson 3
          ...
          subtitles: [
            {
              ...
              words: [
                { text: "Have", start: 8.06, end: 8.2 },
                { text: "you", start: 8.24, end: 8.36 },
                { text: "seen", start: 8.42, end: 8.6 },
                { text: "my", start: 8.66, end: 8.86 },
                { text: "salt?", start: 8.94, end: 9.54 },
              ],
            },
            {
              start: 10.0,
              ...
              words: [
                { text: "I", start: 10.24, end: 10.28 },
                { text: "had", start: 10.32, end: 10.44 },
                { text: "lots", start: 10.54, end: 10.82 },
                { text: "in", start: 10.86, end: 10.98 },
                { text: "the", start: 11.0, end: 11.08 },
                { text: "bag.", start: 11.14, end: 11.58 },
                { text: "Now", start: 12.32, end: 12.48 },
                { text: "I", start: 12.56, end: 12.58 },
                { text: "only", start: 12.64, end: 12.84 },
                { text: "have", start: 12.92, end: 13.04 },
                { text: "a", start: 13.04, end: 13.14 },
                { text: "little", start: 13.2, end: 13.46 },
                { text: "bit.", start: 13.52, end: 13.98 },
              ],
            },
            {
              start: 14.0,
              ...
              words: [
                { text: "I", start: 14.36, end: 14.46 },
                { text: "can't", start: 14.54, end: 14.96 },
                { text: "do", start: 15.04, end: 15.24 },
                { text: "my", start: 15.38, end: 15.56 },
                { text: "experiment.", start: 15.62, end: 16.92 },
              ],
            },
            {
              start: 24.6,
              ...
              words: [
                { text: "No,", start: 24.7, end: 25.0 },
                { text: "sorry,", start: 25.42, end: 25.74 },
                { text: "I", start: 25.96, end: 25.98 },
                { text: "don't", start: 26.04, end: 26.34 },
                { text: "know", start: 26.36, end: 26.5 },
                { text: "where", start: 26.54, end: 26.68 },
                { text: "your", start: 26.76, end: 26.92 },
                { text: "salt", start: 26.98, end: 27.26 },
                { text: "is.", start: 27.34, end: 27.46 },
              ],
            },
            {
              start: 26.5,
              ...
              words: [
                { text: "Adam", start: 17.46, end: 17.78 },
                { text: "feels", start: 17.84, end: 18.16 },
                { text: "sad", start: 18.24, end: 18.54 },
                { text: "that", start: 18.58, end: 18.66 },
                { text: "he", start: 18.7, end: 18.86 },
                { text: "took", start: 18.9, end: 19.1 },
                { text: "Rob's", start: 19.16, end: 19.5 },
                { text: "salt,", start: 19.54, end: 19.9 },
                { text: "but", start: 20.72, end: 20.82 },
                { text: "he", start: 20.86, end: 20.96 },
                { text: "is", start: 21.0, end: 21.16 },
                { text: "scared", start: 21.18, end: 21.56 },
                { text: "he", start: 21.62, end: 21.68 },
                { text: "will", start: 21.74, end: 21.86 },
                { text: "be", start: 21.88, end: 22.02 },
                { text: "angry", start: 22.12, end: 22.42 },
                { text: "if", start: 22.46, end: 22.56 },
                { text: "he", start: 22.58, end: 22.74 },
                { text: "tells", start: 22.78, end: 23.06 },
                { text: "the", start: 23.1, end: 23.16 },
                { text: "truth.", start: 23.28, end: 23.6 },
              ],
            },
          ],
        },
          ...
          subtitles: [
            {
              ...
              words: [
                { text: "Are", start: 0.1, end: 0.2 },
                { text: "you", start: 0.28, end: 0.35 },
                { text: "okay", start: 0.42, end: 0.81 },
              ],
            },
            {
              start: 1.1,
              ...
              words: [
                { text: "I", start: 1.13, end: 1.25 },
                { text: "think", start: 1.27, end: 1.43 },
                { text: "I", start: 1.5, end: 1.59 },
                { text: "forgot", start: 1.63, end: 1.89 },
                { text: "to", start: 1.93, end: 1.99 },
                { text: "bring", start: 2.05, end: 2.18 },
                { text: "enough", start: 2.24, end: 2.46 },
                { text: "salt.", start: 2.61, end: 3.05 },
              ],
            },
            {
              start: 3.3,
              ...
              words: [
                { text: "That's", start: 3.35, end: 3.55 },
                { text: "a", start: 3.59, end: 3.61 },
                { text: "shame.", start: 3.74, end: 4.15 },
                { text: "We", start: 4.67, end: 4.79 },
                { text: "sent", start: 4.83, end: 5.03 },
                { text: "a", start: 5.09, end: 5.13 },
                { text: "letter", start: 5.17, end: 5.42 },
                { text: "home", start: 5.5, end: 5.79 },
                { text: "that", start: 5.87, end: 6.03 },
                { text: "told", start: 6.11, end: 6.39 },
                { text: "you", start: 6.44, end: 6.53 },
                { text: "how", start: 6.57, end: 6.71 },
                { text: "much", start: 6.75, end: 6.96 },
                { text: "you", start: 7.01, end: 7.07 },
                { text: "needed.", start: 7.19, end: 7.59 },
              ],
            },
            {
              start: 12.2,
              ...
              words: [
                { text: "I'm", start: 12.25, end: 12.46 },
                { text: "sorry.", start: 12.53, end: 13.13 },
                { text: "I", start: 13.55, end: 13.59 },
                { text: "took", start: 13.69, end: 13.85 },
                { text: "the", start: 13.89, end: 14.07 },
                { text: "salt", start: 14.13, end: 14.46 },
                { text: "because", start: 14.5, end: 14.73 },
                { text: "I", start: 14.79, end: 14.96 },
                { text: "didn't", start: 15.01, end: 15.39 },
                { text: "have", start: 15.51, end: 15.69 },
                { text: "enough.", start: 15.73, end: 16.37 },
              ],
            },
            {
              start: 16.6,
              ...
              words: [
                { text: "You", start: 16.63, end: 16.71 },
                { text: "did", start: 16.76, end: 16.85 },
                { text: "the", start: 16.89, end: 16.97 },
                { text: "right", start: 17.02, end: 17.23 },
                { text: "thing", start: 17.29, end: 17.44 },
                { text: "by", start: 17.52, end: 17.65 },
                { text: "telling", start: 17.71, end: 17.95 },
                { text: "the", start: 18.0, end: 18.1 },
                { text: "truth.", start: 18.15, end: 18.55 },
                { text: "It", start: 19.19, end: 19.25 },
                { text: "is", start: 19.31, end: 19.47 },
                { text: "good", start: 19.53, end: 19.68 },
                { text: "to", start: 19.71, end: 19.79 },
                { text: "tell", start: 19.85, end: 20.01 },
                { text: "the", start: 20.05, end: 20.13 },
                { text: "truth", start: 20.19, end: 20.45 },
                { text: "when", start: 20.52, end: 20.62 },
                { text: "you", start: 20.63, end: 20.69 },
                { text: "make", start: 20.75, end: 20.87 },
                { text: "a", start: 20.93, end: 20.95 },
                { text: "mistake.", start: 21.0, end: 21.47 },
              ],
            },
            {
              start: 21.9,
              ...
              words: [
                { text: "But", start: 21.92, end: 22.05 },
                { text: "what", start: 22.1, end: 22.23 },
                { text: "about", start: 22.31, end: 22.55 },
                { text: "my", start: 22.6, end: 22.71 },
                { text: "experiment?", start: 22.81, end: 23.6 },
              ],
            },
          ],
        },
          ...
          subtitles: [
            {
              ...
              words: [
                { text: "We", start: 9.2, end: 9.3 },
                { text: "could", start: 9.34, end: 9.46 },
                { text: "ask", start: 9.55, end: 9.69 },
                { text: "the", start: 9.76, end: 9.88 },
                { text: "cook", start: 9.92, end: 10.07 },
                { text: "in", start: 10.11, end: 10.19 },
                { text: "the", start: 10.21, end: 10.26 },
                { text: "cafeteria", start: 10.35, end: 11.17 },
                { text: "if", start: 11.25, end: 11.34 },
                { text: "he", start: 11.35, end: 11.46 },
                { text: "can", start: 11.47, end: 11.63 },
                { text: "give", start: 11.67, end: 11.8 },
                { text: "us", start: 11.84, end: 11.93 },
                { text: "some", start: 11.97, end: 12.09 },
                { text: "salt.", start: 12.25, end: 12.63 },
              ],
            },
            {
              start: 13.0,
              ...
              words: [
                { text: "That's", start: 12.97, end: 13.17 },
                { text: "a", start: 13.21, end: 13.25 },
                { text: "good", start: 13.38, end: 13.51 },
                { text: "idea", start: 13.61, end: 13.96 },
                { text: "Adam.", start: 14.11, end: 14.42 },
              ],
            },
          ],
        },
          ...
          subtitles: [
            {
              ...
              words: [
                ...
                { text: "can", start: 7.4, end: 7.6 },
                { text: "make", start: 7.6, end: 7.8 },
                { text: "your", start: 7.8, end: 8.1 },
                { text: "modeling", start: 8.1, end: 8.5 },
      ...
      extraBubblesData: [
        {
          ...
          words: [
            { text: "Adam", start: 0.079, end: 0.299 },
            { text: "is", start: 0.34, end: 0.439 },
            { text: "at", start: 0.5, end: 0.62 },
            { text: "the", start: 0.659, end: 0.759 },
            { text: "science", start: 0.799, end: 1.1 },
            { text: "fair", start: 1.179, end: 1.48 },
          ],
        },
        {
          videoIndex: 1,
          ...
          words: [
            { text: "and", start: 1.86, end: 1.939 },
            { text: "is", start: 1.959, end: 2.099 },
            { text: "getting", start: 2.159, end: 2.44 },
            { text: "everything", start: 2.519, end: 2.899 },
            { text: "ready", start: 2.98, end: 3.199 },
            { text: "for", start: 3.259, end: 3.339 },
            { text: "his", start: 3.439, end: 3.559 },
            { text: "experiment.", start: 3.679, end: 4.38 },
          ],
        },
        {
          videoIndex: 1,
          ...
          words: [
            { text: "The", start: 5.139, end: 5.299 },
            { text: "children", start: 5.359, end: 5.819 },
            { text: "are", start: 6.119, end: 6.219 },
            { text: "making", start: 6.279, end: 6.559 },
            { text: "modeling", start: 6.679, end: 7.039 },
            { text: "dough.", start: 7.119, end: 7.419 },
          ],
        },
        {
          videoIndex: 1,
          ...
          words: [
            { text: "He", start: 8.159, end: 8.26 },
            { text: "needs", start: 8.3, end: 8.519 },
            { text: "a", start: 8.579, end: 8.659 },
            { text: "scale,", start: 8.699, end: 9.199 },
            { text: "a", start: 9.479, end: 9.539 },
            { text: "bowl,", start: 9.659, end: 10.079 },
            { text: "flour,", start: 10.42, end: 10.899 },
            { text: "water,", start: 11.319, end: 11.659 },
            { text: "and", start: 12.099, end: 12.199 },
            { text: "salt.", start: 12.34, end: 12.719 },
          ],
        },
        {
          videoIndex: 1,
          ...
          words: [
            { text: "He", start: 13.519, end: 13.579 },
            { text: "measures", start: 13.659, end: 13.96 },
            { text: "all", start: 14.039, end: 14.159 },
            { text: "his", start: 14.239, end: 14.359 },
            { text: "ingredients,", start: 14.42, end: 15.079 },
            { text: "but", start: 15.519, end: 15.599 },
            { text: "he", start: 15.639, end: 15.739 },
            { text: "doesn't", start: 15.799, end: 16.099 },
            { text: "have", start: 16.18, end: 16.299 },
            { text: "enough", start: 16.34, end: 16.659 },
            { text: "salt.", start: 16.76, end: 17.159 },
          ],
        },
        {
          videoIndex: 1,
          ...
          words: [
            { text: "Oh", start: 17.619, end: 17.699 },
            { text: "no,", start: 17.84, end: 18.1 },
          ],
        },
        {
          videoIndex: 1,
          ...
          words: [
            { text: "his", start: 18.559, end: 18.659 },
            { text: "experiment", start: 18.76, end: 19.34 },
            { text: "won't", start: 19.42, end: 19.619 },
            { text: "work.", start: 19.739, end: 20.139 },
          ],
        },
        {
          videoIndex: 1,
          ...
          words: [
            { text: "While", start: 20.819, end: 20.939 },
            { text: "the", start: 20.979, end: 21.04 },
            { text: "boy", start: 21.119, end: 21.279 },
            { text: "next", start: 21.34, end: 21.5 },
            { text: "to", start: 21.539, end: 21.619 },
            { text: "him", start: 21.659, end: 21.779 },
            { text: "is", start: 21.819, end: 21.959 },
            { text: "chatting,", start: 22.02, end: 22.479 },
            { text: "Adam", start: 22.859, end: 23.139 },
            { text: "takes", start: 23.199, end: 23.439 },
            { text: "some", start: 23.5, end: 23.659 },
            { text: "salt", start: 23.84, end: 24.139 },
            { text: "from", start: 24.219, end: 24.359 },
            { text: "his", start: 24.42, end: 24.579 },
            { text: "table.", start: 24.639, end: 25.059 },
          ],
        },
        {
          videoIndex: 1,
          ...
          words: [
            { text: "Now", start: 25.639, end: 25.819 },
            { text: "he", start: 25.879, end: 25.979 },
            { text: "has", start: 26.059, end: 26.339 },
            { text: "everything", start: 26.439, end: 26.899 },
            { text: "he", start: 27.0, end: 27.139 },
            { text: "needs.", start: 27.199, end: 27.68 },
          ],
        },

        {
          ...
          words: [
            { text: "Adam's", start: 0.28, end: 0.62 },
            { text: "experiment", start: 0.7, end: 1.34 },
            { text: "is", start: 1.54, end: 1.64 },
            { text: "good.", start: 1.82, end: 2.04 },
          ],
        },
        {
          videoIndex: 2,
          ...
          words: [
            { text: "His", start: 2.66, end: 2.82 },
            { text: "modeling", start: 2.92, end: 3.3 },
            { text: "dough", start: 3.42, end: 3.88 },
            { text: "is", start: 3.98, end: 4.12 },
            { text: "perfect.", start: 4.34, end: 4.9 },
          ],
        },
        {
          videoIndex: 2,
          ...
          words: [
            { text: "Rob", start: 5.82, end: 6.1 },
            { text: "does", start: 6.14, end: 6.36 },
            { text: "not", start: 6.4, end: 6.66 },
            { text: "look", start: 6.94, end: 7.1 },
            { text: "happy.", start: 7.26, end: 7.5 },
          ],
        },
        {
          videoIndex: 2,
...

        {
          ...
          words: [
            { text: "Adam", start: 7.94, end: 8.25 },
            { text: "feels", start: 8.35, end: 8.64 },
            { text: "terrible.", start: 8.73, end: 9.27 },
            { text: "He", start: 9.73, end: 9.84 },
            { text: "decides", start: 9.88, end: 10.53 },
            { text: "to", start: 10.57, end: 10.69 },
            { text: "tell", start: 10.76, end: 10.93 },
            { text: "the", start: 11.0, end: 11.09 },
            { text: "truth.", start: 11.17, end: 11.53 },
          ],
        },

        {
          ...
          words: [
            { text: "Adam", start: 0.25, end: 0.62 },
            { text: "offers", start: 0.75, end: 1.05 },
            { text: "Rob", start: 1.12, end: 1.33 },
            { text: "his", start: 1.36, end: 1.48 },
            { text: "modelling", start: 1.55, end: 1.93 },
            { text: "dough,", start: 2.0, end: 2.24 },
          ],
        },
        {
          videoIndex: 4,
          ...
          words: [
            { text: "but", start: 2.85, end: 2.93 },
            { text: "Rob", start: 3.01, end: 3.19 },
            { text: "isn't", start: 3.24, end: 3.43 },
            { text: "happy.", start: 3.51, end: 3.81 },
          ],
        },
        {
          videoIndex: 4,
          ...
          words: [
            { text: "He", start: 4.83, end: 4.94 },
            { text: "wants", start: 4.98, end: 5.21 },
            { text: "to", start: 5.25, end: 5.35 },
            { text: "make", start: 5.42, end: 5.69 },
            { text: "his", start: 5.81, end: 6.05 },
            { text: "own", start: 6.15, end: 6.39 },
            { text: "modelling", start: 6.5, end: 6.85 },
            { text: "dough.", start: 6.94, end: 7.19 },
          ],
        },
        {
          videoIndex: 4,
          ...
          words: [
            { text: "Adam", start: 7.65, end: 7.94 },
            { text: "has", start: 8.0, end: 8.11 },
            { text: "an", start: 8.15, end: 8.23 },
            { text: "idea.", start: 8.3, end: 8.67 },
          ],
        },

        {
          ...
          words: [
            { text: "Adam", start: 0.3, end: 0.6 },
            { text: "and", start: 0.7, end: 0.8 },
            { text: "Rob", start: 0.9, end: 1.2 },
            { text: "go", start: 1.7, end: 1.9 },
            { text: "to", start: 1.9, end: 2.0 },
            { text: "the", start: 2.0, end: 2.1 },
            { text: "kitchen", start: 2.2, end: 2.6 },
            { text: "and", start: 3.2, end: 3.3 },
            { text: "ask", start: 3.5, end: 3.7 },
            { text: "the", start: 3.8, end: 3.9 },
            { text: "cook", start: 4.0, end: 4.3 },
            { text: "for", start: 4.4, end: 4.5 },
            { text: "some", start: 4.6, end: 4.7 },
            { text: "salt.", start: 4.8, end: 5.1 },
          ],
        },
        {
          videoIndex: 5,
          ...
          words: [
            ...
            { text: "fix", start: 11.7, end: 11.9 },
            { text: "his", start: 11.9, end: 12.1 },
            { text: "mistake", start: 12.1, end: 12.5 },
            { text: "and", start: 12.5, end: 12.7 },
            { text: "help", start: 12.7, end: 13.0 },
            { text: "Rob.", start: 13.0, end: 13.4 },
          ],
        },
      ],
      interactiveTask: {
          ...
          subtitles: [
            {
              ...
              words: [{ text: "Noah!", start: 0.159, end: 0.74 }],
            },
    ...
    2: {
          ...
          subtitles: [
            {
              ...
              words: [
                { text: "Hello.", start: 15.359, end: 15.739 },
                { text: "What's", start: 16.0, end: 16.2 },
                { text: "your", start: 16.239, end: 16.399 },
                { text: "name?", start: 16.42, end: 16.699 },
              ],
            },
          ],
        },
          ...
          subtitles: [
            {
              ...
              words: [
                { text: "Your", start: 6.859, end: 7.019 },
                { text: "shop", start: 7.219, end: 7.559 },
                { text: "is", start: 7.619, end: 7.98 },
                { text: "boring.", start: 8.039, end: 8.72 },
              ],
            },
          ],
        },
          ...
          subtitles: [
            {
              ...
              words: [
                { text: "I'm", start: 10.719, end: 10.96 },
                { text: "sorry", start: 11.039, end: 11.479 },
                { text: "I", start: 12.039, end: 12.059 },
                { text: "was", start: 12.139, end: 12.3 },
                { text: "rude", start: 12.42, end: 12.739 },
                { text: "before.", start: 12.799, end: 13.279 },
              ],
            },
            {
              start: 15.159,
              ...
              words: [
                { text: "I", start: 15.159, end: 15.18 },
                { text: "was", start: 15.239, end: 15.4 },
                { text: "feeling", start: 15.5, end: 15.88 },
                { text: "angry", start: 15.979, end: 16.359 },
                { text: "with", start: 16.459, end: 16.619 },
                { text: "waiting", start: 16.739, end: 17.079 },
                { text: "around,", start: 17.199, end: 17.619 },
                { text: "and", start: 17.699, end: 17.84 },
                { text: "I", start: 18.0, end: 18.02 },
                { text: "should", start: 18.159, end: 18.34 },
                { text: "not", start: 18.44, end: 18.639 },
                { text: "have", start: 18.699, end: 18.819 },
                { text: "spoken", start: 18.92, end: 19.459 },
                { text: "rudely", start: 19.539, end: 19.899 },
                { text: "to", start: 19.959, end: 20.079 },
                { text: "you.", start: 20.139, end: 20.359 },
              ],
            },
            {
              start: 20.979,
              ...
              words: [
                { text: "It", start: 21.979, end: 22.1 },
                { text: "was", start: 22.139, end: 22.299 },
                { text: "wrong.", start: 22.459, end: 22.859 },
              ],
            },
            {
              start: 24.779,
              end: 27.639, // قصيتها حسب الجملة الأولى
              words: [
                { text: "That's", start: 24.779, end: 24.959 },
                { text: "okay.", start: 25.019, end: 25.379 },
                { text: "I", start: 26.099, end: 26.119 },
                { text: "understand", start: 26.159, end: 26.639 },
                { text: "you", start: 26.68, end: 26.739 },
                { text: "were", start: 26.76, end: 26.84 },
                { text: "becoming", start: 26.879, end: 27.239 },
                { text: "angry,", start: 27.319, end: 27.639 },
              ],
            },
            {
              start: 28.039,
              ...
              words: [
                { text: "and", start: 28.039, end: 28.119 },
                { text: "I'm", start: 28.159, end: 28.279 },
                { text: "sure", start: 28.319, end: 28.479 },
                { text: "you", start: 28.519, end: 28.599 },
                { text: "don't", start: 28.639, end: 28.84 },
                { text: "speak", start: 28.859, end: 29.119 },
                { text: "like", start: 29.159, end: 29.299 },
                { text: "that", start: 29.359, end: 29.539 },
                { text: "all", start: 29.639, end: 29.78 },
                { text: "the", start: 29.799, end: 29.899 },
                { text: "time.", start: 29.959, end: 30.279 },
              ],
            },
          ],
        },
          ...
          subtitles: [
            {
              ...
              words: [
                { text: "I'm", start: 0.439, end: 0.56 },
                { text: "happy", start: 0.659, end: 0.939 },
                { text: "you", start: 0.959, end: 1.039 },
                { text: "were", start: 1.059, end: 1.159 },
                { text: "able", start: 1.22, end: 1.399 },
                { text: "to", start: 1.419, end: 1.539 },
                { text: "see", start: 1.579, end: 1.759 },
                { text: "how", start: 1.759, end: 1.939 },
                { text: "your", start: 1.959, end: 2.159 },
                { text: "words", start: 2.18, end: 2.599 },
                { text: "hurt", start: 2.7, end: 2.879 },
                { text: "Mr.", start: 2.899, end: 3.159 },
                { text: "Harrison", start: 3.22, end: 3.599 },
              ],
            },
            {
              start: 4.199,
              ...
              words: [
                { text: "and", start: 4.199, end: 4.579 },
                { text: "that", start: 4.619, end: 4.739 },
                { text: "you", start: 4.759, end: 4.819 },
                { text: "apologized.", start: 4.94, end: 5.599 },
              ],
            },
          ],
        },
          ...
          subtitles: [
            {
              ...
              words: [
                { text: "I", start: 4.059, end: 4.199 },
                { text: "like", start: 4.299, end: 4.42 },
                { text: "your", start: 4.48, end: 4.579 },
                { text: "window", start: 4.599, end: 4.859 },
                { text: "display,", start: 4.94, end: 5.44 },
              ],
            },
            {
              start: 6.259,
              ...
              words: [
                { text: "and", start: 6.259, end: 6.379 },
                { text: "I", start: 6.44, end: 6.519 },
                { text: "like", start: 6.599, end: 6.719 },
                { text: "your", start: 6.759, end: 6.879 },
                { text: "nice", start: 6.899, end: 7.139 },
                { text: "chairs", start: 7.179, end: 7.519 },
                { text: "by", start: 7.599, end: 7.679 },
                { text: "the", start: 7.719, end: 7.799 },
                { text: "changing", start: 7.839, end: 8.199 },
                { text: "rooms.", start: 8.279, end: 8.659 },
              ],
            },
            {
              start: 10.159,
              ...
              words: [
                { text: "Well,", start: 10.159, end: 10.679 },
                { text: "thank", start: 10.76, end: 10.979 },
                { text: "you.", start: 11.119, end: 11.34 },
              ],
            },
      ...
      cloudPositions: {
        ...
        3: [
          ...
          { bottom: "75%", left: "40%", isFlipped: true },
          { bottom: "75%", left: "50%", isFlipped: true },
           { top: "15%", left: "35%" },
           { top: "15%", left: "35%" },
      ...
      extraBubblesData: [
        {
          ...
          words: [
            { text: "Ellen", start: 0.159, end: 0.5 },
            { text: "is", start: 0.56, end: 0.699 },
            { text: "bored.", start: 0.74, end: 1.12 },
          ],
        },
        {
          videoIndex: 1,
          ...
          words: [
            { text: "She", start: 1.759, end: 1.86 },
            { text: "is", start: 1.899, end: 1.999 },
            { text: "in", start: 2.019, end: 2.079 },
            { text: "a", start: 2.119, end: 2.2 },
            { text: "men's", start: 2.22, end: 2.539 },
            { text: "clothing", start: 2.599, end: 2.96 },
            { text: "store", start: 3.039, end: 3.299 },
            { text: "with", start: 3.339, end: 3.5 },
            { text: "her", start: 3.519, end: 3.659 },
            { text: "dad,", start: 3.699, end: 4.019 },
            { text: "and", start: 4.199, end: 4.299 },
            { text: "there", start: 4.339, end: 4.42 },
            { text: "is", start: 4.46, end: 4.739 },
            { text: "nothing", start: 4.779, end: 5.179 },
            { text: "interesting", start: 5.259, end: 5.759 },
            { text: "for", start: 5.859, end: 5.94 },
            { text: "her", start: 6.0, end: 6.139 },
            { text: "to", start: 6.159, end: 6.279 },
            { text: "do.", start: 6.319, end: 7.339 },
          ],
        },
        {
          videoIndex: 1,
          ...
          words: [
            { text: "She", start: 7.44, end: 7.5 },
            { text: "is", start: 7.539, end: 7.679 },
            { text: "waiting", start: 7.699, end: 8.18 },
            { text: "while", start: 8.22, end: 8.36 },
            { text: "her", start: 8.38, end: 8.52 },
            { text: "dad", start: 8.539, end: 8.76 },
            { text: "chooses", start: 8.84, end: 9.199 },
            { text: "a", start: 9.239, end: 9.26 },
            { text: "new", start: 9.359, end: 9.539 },
            { text: "coat.", start: 9.599, end: 9.96 },
          ],
        },
        {
          videoIndex: 1,
          ...
          words: [
            { text: "The", start: 10.8, end: 10.84 },
            { text: "shopkeeper", start: 10.939, end: 11.559 },
            { text: "notices", start: 11.619, end: 12.22 },
            { text: "that", start: 12.239, end: 12.3 },
            { text: "she", start: 12.399, end: 12.5 },
            { text: "is", start: 12.539, end: 12.659 },
            { text: "unhappy", start: 12.699, end: 13.46 },
            { text: "and", start: 13.5, end: 13.64 },
            { text: "goes", start: 13.659, end: 13.9 },
            { text: "over", start: 14.0, end: 14.199 },
            { text: "to", start: 14.219, end: 14.36 },
            { text: "say", start: 14.399, end: 14.559 },
            { text: "hello.", start: 14.599, end: 14.979 },
          ],
        },

        {
          ...
          words: [
            { text: "Ellen", start: 0.28, end: 0.5 },
            { text: "does", start: 0.56, end: 0.759 },
            { text: "not", start: 0.779, end: 0.899 },
            { text: "respond", start: 0.939, end: 1.439 },
            { text: "and", start: 1.699, end: 1.899 },
            { text: "does", start: 1.899, end: 2.099 },
            { text: "not", start: 2.119, end: 2.24 },
            { text: "smile.", start: 2.259, end: 2.619 },
          ],
        },
        {
          videoIndex: 2,
          ...
          words: [
            { text: "The", start: 3.319, end: 3.359 },
            { text: "shopkeeper", start: 3.419, end: 3.879 },
            { text: "asks", start: 3.98, end: 4.319 },
            { text: "what", start: 4.759, end: 4.859 },
            { text: "the", start: 4.9, end: 4.96 },
            { text: "matter", start: 5.0, end: 5.279 },
            { text: "is.", start: 5.359, end: 5.539 },
          ],
        },
        {
          videoIndex: 2,
          ...
          words: [
            { text: "She", start: 9.84, end: 9.92 },
            { text: "answers", start: 9.96, end: 10.239 },
            { text: "rudely", start: 10.34, end: 10.739 },
            { text: "as", start: 11.139, end: 11.22 },
            { text: "she", start: 11.239, end: 11.34 },
            { text: "turns", start: 11.38, end: 11.659 },
            { text: "around", start: 11.699, end: 11.94 },
            { text: "to", start: 11.94, end: 12.039 },
            { text: "walk", start: 12.079, end: 12.259 },
            { text: "away.", start: 12.359, end: 12.979 },
          ],
        },
        {
          videoIndex: 2,
          ...
          words: [
            { text: "The", start: 13.039, end: 13.079 },
            { text: "shopkeeper", start: 13.199, end: 13.679 },
            { text: "does", start: 13.719, end: 13.96 },
            { text: "not", start: 13.979, end: 14.159 },
            { text: "look", start: 14.179, end: 14.299 },
            { text: "happy.", start: 14.399, end: 14.699 },
            { text: "Ellen", start: 15.279, end: 15.52 },
            { text: "has", start: 15.559, end: 15.68 },
            { text: "hurt", start: 15.719, end: 15.88 },
            { text: "his", start: 15.92, end: 16.02 },
            { text: "feelings.", start: 16.1, end: 16.68 },
          ],
        },
        {
          videoIndex: 3,
          ...
          words: [
            { text: "Ellen", start: 0.179, end: 0.459 },
            { text: "notices", start: 0.519, end: 0.939 },
            { text: "the", start: 1.0, end: 1.039 },
            { text: "shopkeeper's", start: 1.12, end: 1.62 },
            { text: "surprised", start: 1.659, end: 2.099 },
            { text: "face,", start: 2.22, end: 2.559 },
          ],
        },
        {
          videoIndex: 3,
          ...
          words: [
            ...
            { text: "she", start: 3.579, end: 3.72 },
            { text: "realizes", start: 3.779, end: 4.299 },
            { text: "she", start: 4.44, end: 4.639 },
            { text: "has", start: 4.719, end: 4.92 },
            { text: "hurt", start: 5.0, end: 5.199 },
            { text: "his", start: 5.259, end: 5.38 },
            { text: "feelings", start: 5.46, end: 5.879 },
            { text: "by", start: 6.379, end: 6.5 },
            { text: "being", start: 6.559, end: 6.739 },
            { text: "rude", start: 6.839, end: 7.119 },
          ],
        },
        {
          videoIndex: 3,
          ...
          words: [
            { text: "and", start: 8.34, end: 8.479 },
            { text: "feels", start: 8.559, end: 8.84 },
            { text: "bad.", start: 8.92, end: 9.22 },
          ],
        },
        {
          videoIndex: 3,
          ...
          words: [
            { text: "Ellen's", start: 31.34, end: 31.619 },
            { text: "father", start: 31.699, end: 32.04 },
            { text: "walks", start: 32.079, end: 32.319 },
            { text: "up", start: 32.38, end: 32.5 },
            { text: "to", start: 32.52, end: 32.599 },
            { text: "the", start: 32.619, end: 32.659 },
            { text: "shopkeeper", start: 32.739, end: 33.379 },
            { text: "and", start: 33.439, end: 33.559 },
            { text: "Ellen", start: 33.619, end: 33.819 },
          ],
        },

        {
          ...
          words: [
            { text: "Dad", start: 0.259, end: 0.5 },
            { text: "buys", start: 0.539, end: 0.74 },
            { text: "a", start: 0.779, end: 0.839 },
            { text: "coat", start: 0.899, end: 1.339 },
            { text: "and", start: 1.379, end: 1.5 },
            { text: "they", start: 1.539, end: 1.699 },
            { text: "start", start: 1.759, end: 2.0 },
            { text: "to", start: 2.019, end: 2.099 },
            { text: "make", start: 2.139, end: 2.279 },
            { text: "their", start: 2.319, end: 2.46 },
            { text: "way", start: 2.5, end: 2.7 },
            { text: "out", start: 2.759, end: 2.899 },
            { text: "of", start: 2.939, end: 3.039 },
            { text: "the", start: 3.059, end: 3.139 },
            { text: "store.", start: 3.179, end: 3.399 },
          ],
        },
        {
          videoIndex: 5,
          ...
          words: [
            { text: "Ellen", start: 11.92, end: 12.199 },
            { text: "feels", start: 12.359, end: 12.659 },
            { text: "happy", start: 12.799, end: 13.1 },
            { text: "she", start: 13.239, end: 13.299 },
            { text: "apologized", start: 13.42, end: 14.06 },
            { text: "to", start: 14.06, end: 14.119 },
            { text: "the", start: 14.159, end: 14.199 },
            { text: "shopkeeper.", start: 14.279, end: 14.88 },
          ],
        },
      ],
      interactiveTask: {
          ...
          subtitles: [
            {
              ...
              words: [{ text: "Congratulations!", start: 0.099, end: 1.22 }],
            },
          ],
        },
        {
          ...
          subtitles: [
            {},
            {
              ...
              words: [{ text: "Hello.", start: 2.72, end: 3.24 }],
            },
            {
              start: 3.839,
              end: 4.42,
              words: [{ text: "Hello,", start: 3.839, end: 4.42 }],
            },
            {
              start: 5.619,
              end: 7.159,
              words: [
                { text: "and", start: 5.619, end: 5.819 },
                { text: "congratulations!", start: 5.9, end: 7.159 },
              ],
            },
            {
              start: 7.759,
              ...
              words: [
                { text: "Are", start: 7.759, end: 7.879 },
                { text: "we", start: 7.96, end: 8.119 },
                { text: "too", start: 8.159, end: 8.26 },
                { text: "noisy?", start: 8.42, end: 8.819 },
              ],
            },
            {
              start: 9.059,
            ...
            },
            {
              ...
              words: [
                { text: "It's", start: 11.279, end: 11.48 },
                { text: "fine.", start: 11.659, end: 12.219 },
              ],
            },
            {
              start: 12.84,
              ...
              words: [
                { text: "It's", start: 12.84, end: 13.119 },
                { text: "fun", start: 13.179, end: 13.42 },
                { text: "to", start: 13.479, end: 13.619 },
                { text: "celebrate", start: 13.619, end: 14.1 },
                { text: "with", start: 14.119, end: 14.22 },
                { text: "family", start: 14.299, end: 14.579 },
                { text: "and", start: 14.619, end: 14.699 },
                { text: "friends.", start: 14.819, end: 15.179 },
              ],
            },
            {
              start: 14.5,
        ...
        },
        {
          ...
          subtitles: [
            ...
            {},
            {
              ...
              words: [
                { text: "Thank", start: 8.3, end: 8.559 },
                { text: "you.", start: 8.639, end: 8.88 },
              ],
            },
            {
              start: 11.179,
              ...
              words: [
                { text: "It's", start: 11.179, end: 11.359 },
                { text: "delicious.", start: 11.42, end: 12.019 },
              ],
            },
            {},
            {},
          ...
          subtitles: [
            ...
            {},
            {
              ...
              words: [
                ...
                { text: "noise", start: 7.179, end: 7.48 },
            ...
            },
            {
              ...
              words: [
                ...
                { text: "people", start: 10.099, end: 10.4 },
                { text: "around", start: 10.439, end: 10.8 },
      ...
      extraBubblesData: [
        {
          ...
          words: [
            ...
            { text: "Brian's", start: 1.919, end: 2.379 },
        ...
        },
        {
          ...
          words: [
            ...
            { text: "says,", start: 2.019, end: 2.299 },
        ...
        },
        {
          ...
          words: [
            { text: "Brian", start: 0.14, end: 0.459 },
            { text: "thinks", start: 0.5, end: 0.759 },
            { text: "for", start: 0.779, end: 0.859 },
            { text: "a", start: 0.959, end: 0.979 },
            { text: "moment.", start: 1.019, end: 1.439 },
          ],
        },

        {
          ...
          words: [
            { text: "He", start: 2.759, end: 2.899 },
            { text: "cuts", start: 2.96, end: 3.299 },
            { text: "a", start: 3.359, end: 3.439 },
            { text: "piece", start: 3.48, end: 3.74 },
            { text: "of", start: 3.759, end: 3.839 },
            { text: "his", start: 3.859, end: 4.019 },
            { text: "cake", start: 4.039, end: 4.42 },
            { text: "and", start: 4.48, end: 4.639 },
            { text: "passes", start: 4.679, end: 5.079 },
            { text: "it", start: 5.099, end: 5.239 },
            { text: "to", start: 5.259, end: 5.339 },
            { text: "his", start: 5.38, end: 5.539 },
            { text: "neighbor", start: 5.559, end: 5.94 },
            { text: "over", start: 6.359, end: 6.519 },
            { text: "the", start: 6.559, end: 6.639 },
            { text: "fence.", start: 6.699, end: 7.119 },
          ],
        },

        {
          ...
          words: [
            { text: "Brian", start: 12.779, end: 13.059 },
            { text: "goes", start: 13.099, end: 13.319 },
            { text: "back", start: 13.38, end: 13.56 },
            { text: "to", start: 13.56, end: 13.639 },
            { text: "the", start: 13.679, end: 13.759 },
            { text: "party", start: 13.799, end: 14.119 },
            { text: "and", start: 14.159, end: 14.279 },
            { text: "plays", start: 14.319, end: 14.6 },
            { text: "more", start: 14.659, end: 14.84 },
            { text: "games", start: 14.88, end: 15.18 },
            { text: "with", start: 15.199, end: 15.34 },
            { text: "his", start: 15.359, end: 15.5 },
            { text: "friends.", start: 15.539, end: 15.979 },
          ],
        },

        {
          ...
          words: [
            { text: "He's", start: 16.559, end: 16.819 },
            { text: "happy", start: 16.899, end: 17.159 },
            { text: "that", start: 17.199, end: 17.319 },
            { text: "he", start: 17.34, end: 17.46 },
            { text: "considered", start: 17.5, end: 18.04 },
            { text: "his", start: 18.059, end: 18.2 },
            { text: "neighbor's", start: 18.26, end: 18.6 },
            { text: "feelings.", start: 18.699, end: 19.04 },
          ],
        },
        {
          videoIndex: 4,
          ...
          words: [
            { text: "asks", start: 3.099, end: 3.399 },
